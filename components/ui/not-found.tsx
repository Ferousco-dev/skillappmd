...
interface NotFoundProps {
  title?: string
  description?: string
  /** Where "Take me home" points. */
  homeHref?: string
  /** Where the search box submits. Matches the landing page's `?q=` contract. */
  searchAction?: string
}
    ...
    <div className="relative text-center z-[1] pt-52">
      ...
      >
        <div className="relative w-full">
          ...
          <Input name="q" aria-label="Search skills" placeholder="Search" className="pl-8" />
        </div>
