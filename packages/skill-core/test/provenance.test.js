...
test('TC-024 DOM-006 source facts and inferences are distinguishable', () => {
...
test('TC-025 NFR-004 a record without attribution is rejected AT WRITE TIME', () => {
...
test('TC-026 NFR-005 every field origin must be classifiable', () => {
...
test('TC-027 REQ-076 an inference without producer/version/at is not storable', () => {
...
test('TC-028 DOM-013 identity resolves to three classes', () => {
...
test('TC-029 REQ-092 a person-linked field without a stated purpose is not stored', () => {
